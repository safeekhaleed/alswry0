        ...
        <View style={[mo.sheet, { backgroundColor: colors.card }]}>
          ...
          {result ? (
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ gap: 14, paddingBottom: 28 }}>
              ...
              <TouchableOpacity
                style={[mo.submitBtn, { backgroundColor: colors.primary }]}
                onPress={handleClose}
                activeOpacity={0.85}
              >
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 28 }}>
              <View style={mo.serviceInfo}>
                ...
                <View style={{ flex: 1, gap: 4 }}>
                  ...
                  <Text style={[mo.serviceDesc, { color: colors.mutedForeground }]} numberOfLines={2}>
                    {service.description}
                  </Text>
                </View>
              ...
              <View style={[mo.balanceRow, { backgroundColor: colors.secondary, borderColor: colors.border }]}>
                ...
                <Text style={[mo.balanceValue, { color: canAfford || price === 0 ? "#34d399" : "#ef4444" }]}>
                  ${balance.toFixed(2)}
                </Text>
              </View>
              ...
              {price > 0 && !canAfford && (
                <View style={[mo.warningBox, { backgroundColor: "#ef444415", borderColor: "#ef444430" }]}>
                  ...
                  <Text style={[mo.warningText, { color: "#ef4444" }]}>
                    رصيدك غير كافٍ. تحتاج ${(price - balance).toFixed(2)} إضافية. يرجى شحن الرصيد أولاً.
                  </Text>
                </View>
              )}
              ...
              <TouchableOpacity
                style={[
                  mo.submitBtn,
                  {
                    backgroundColor: price > 0 && !canAfford ? colors.border : colors.primary,
                    marginTop: 14,
                  },
                  (sending || (price > 0 && !canAfford)) && { opacity: 0.7 },
                ]}
              ...
              >
                <Feather
                  name={price === 0 ? "gift" : "credit-card"}
                  size={16}
                  color={price > 0 && !canAfford ? colors.mutedForeground : "#0f1624"}
                />
