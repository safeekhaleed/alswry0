    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {isLoading ? (
        ...
        <View style={styles.center}>
          ...
          <Text style={[styles.emptyText, { color: colors.mutedForeground }]}>خطأ في تحميل الدروس</Text>
          <TouchableOpacity
        ...
        <View style={styles.center}>
          ...
          <Text style={[styles.emptyText, { color: colors.mutedForeground }]}>لا توجد دروس متاحة</Text>
        </View>
      ) : (
        <FlatList
          data={filtered}
...
const styles = StyleSheet.create({
  ...
  filterChipText: { fontFamily: "Cairo_400Regular", fontSize: 13 },
  ...
  cardHeader: { gap: 6, alignItems: "flex-end" },
  cardTitleRow: { flexDirection: "row-reverse", alignItems: "center", gap: 8 },
  publishedDot: { width: 8, height: 8, borderRadius: 4, flexShrink: 0 },
  cardTitle: { fontFamily: "Cairo_600SemiBold", fontSize: 16, flex: 1, textAlign: "right" },
  durationBadge: { flexDirection: "row-reverse", alignItems: "center", alignSelf: "flex-end", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10, gap: 4 },
  durationText: { fontFamily: "Cairo_400Regular", fontSize: 11 },
  cardDescription: { fontFamily: "Cairo_400Regular", fontSize: 13, lineHeight: 20, textAlign: "right" },
